      ...
      <div className="relative w-full max-w-md rounded bg-white p-6 shadow-lg">
        ...
        <div className="mb-4 flex items-center gap-4">
          <img
            src={pet.photoUrl}
            alt={pet.name}
            className="h-24 w-24 rounded-md border border-gray-300 object-cover shadow-sm" // ⬅ square with rounded corners
          />
        ...
        <div className="space-y-1 text-sm font-medium text-gray-700">
          ...
          <p>
            <strong>Desexed:</strong> {pet.desexed ? 'Yes' : 'No'}
          </p>
          <p>
          ...
          <p>
            <strong>Last Seen:</strong> {pet.lastSeenDate}
          </p>
          <p>
            <strong>Lost:</strong> {pet.lost ? 'Yes' : 'No'}
          </p>
          <p>
            <strong>Registration #:</strong> {pet.registrationNumber}
          </p>
        </div>
      </div>
    </div>
